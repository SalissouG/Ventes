            ...
            try
            {
                if (_userToEdit == null)
                {
                    ...
                    using (var db = new AppDbContext())
                    {
                        ...
                        await db.SaveChangesAsync(); // Save new user to the database
                    }

                    await DisplayAlert("Utilisateur Créé", $"Utilisateur {newUser.Nom} ajouté avec succès.", "OK");
                }
                else
                {
                    ...
                    await DisplayAlert("Utilisateur Modifié", $"Utilisateur {_userToEdit.Nom} modifié avec succès.", "OK");
                }
